...
if ($_REQUEST['project']) {
    ...
    $sql = "SELECT timestamps.overlays_id, overlay_name, overlay_type, overlay_props, video_time_from, video_time_to, timestamps_id FROM overlays INNER JOIN timestamps ON overlays.overlays_id = timestamps.overlays_id WHERE project_id = ".$project;
